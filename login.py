...
class Login:
    def __init__(self,root):
        ...
        #entry1 
        self.txtusername=ttk.Entry(frame1,font=("times new roman",15,"bold"))
        self.txtusername.place(x=33,y=190,width=270)
    ...
    def login(self):
        if (self.txtusername.get()=="" or self.txtpwd.get()==""):
            messagebox.showerror("Error","All Field Required!")
        elif(self.txtusername.get()=="admin" and self.txtpwd.get()=="admin"):
...
#=======================Reset Passowrd Function=============================
    def reset_pass(self):
        if self.var_ssq.get()=="Select":
            ...
            value=(self.txtusername.get(),self.var_ssq.get(),self.var_sa.get())
            ...
            if row==None:
                ...
                value=(self.var_pwd.get(),self.txtusername.get())
                cursor.execute(query,value)
