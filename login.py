...
class Login:
    def __init__(self,root):
        ...
        loginbtn = Button(frame1,  text="Login",command=self.login, font=("times new roman", 15, "bold"), bd=0,
        ...
        loginbtn = Button(frame1, text="Forget",command=self.forget_pwd, font=("times new roman", 10, "bold"), bd=0,
                    ...
                    if self.var_ssq.get() == "Select":
                        ...
                        if row == None:
                            ...
                            messagebox.showinfo("Info",
                                                "Successfully Your password has been rest, Please login with new Password!",
                                                parent=self.root2)
