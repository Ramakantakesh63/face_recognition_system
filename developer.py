...
class Developer:
    def __init__(self,root):
        ...
        std_b1.place(x=250, y=180, width=185, height=210)

        std_b1_1 = Button(bg_img, text="R.kesh", cursor="hand2", font=("tahoma", 15, "bold"), bg="white",
                          fg="navyblue")
        std_b1_1.place(x=250, y=380, width=185, height=45)
        ...
        det_b1.place(x=480, y=200, width=185, height=210)

        det_b1_1 = Button(bg_img, text="P.R.bahali", cursor="hand2", font=("tahoma", 15, "bold"), bg="white",
                          fg="navyblue")
        det_b1_1.place(x=480, y=380, width=185, height=45)
        ...
        det_b2.place(x=680, y=200, width=180, height=180)

        det_b2_1 = Button(bg_img, text="A.K.rana", cursor="hand2", font=("tahoma", 15, "bold"), bg="white",
                          fg="navyblue")
        det_b2_1.place(x=680, y=380, width=180, height=45)
        ...
        det_b3.place(x=880, y=200, width=180, height=180)

        det_b2_2 = Button(bg_img, text="P.C.barik", cursor="hand2", font=("tahoma", 15, "bold"), bg="white",
                          fg="navyblue")
        det_b2_2.place(x=880, y=380, width=180, height=45)
